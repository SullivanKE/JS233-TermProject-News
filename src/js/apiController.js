...
export async function getHeadlines(publishedOn = "", locale = "us", language = "en") {
    //Example response
    /*
        {
"data": {
...
export async function topStories(search = "", searchFields = "", categories = "", publishedOn = "", publishedBefore = "", publishedAfter = "", locale = "us", language = "en") {
    //Example response
    /*
        {
"meta": {
...
export async function allNews(search = "", searchFields = "", categories = "", publishedOn = "", publishedBefore = "", publishedAfter = "", locale = "us", language = "en") {
    //Example response
    /*
        {
"meta": {
...
export async function similarNews(uuid, categories = "", publishedOn = "", publishedBefore = "", publishedAfter = "", locale = "us", language = "en") {
    //Example response
    /*
        {
"meta": {
...
export async function newsByUUID(uuid) {
    //Example response
    /*
    {
